...
import { exportOutputPath } from "./exportFast.js";
...
import { buildShortDescription } from "./shortHook.js";
...
import { estimatedRunSec, matchStartIntoVodSec } from "./vodAcquisition.js";
 ...
 * files only: an `.edited.txt` sibling still wins everywhere (src/title.ts `metaPaths`).
 */
 ...
 * (src/shortMoment.ts, chat included). The operator's judgement can replace it — cut any game's
