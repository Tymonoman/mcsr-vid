...
import { SPLITS_MANIFEST } from "../pipeline/overlayRender.js";
import type { StageId } from "../pipeline/pipeline.js";
 ...
 * files `runPipeline` (src/pipeline/pipeline.ts) checks via `existsSync` to skip/reuse a stage.
 */
/**
