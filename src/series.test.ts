...
import type { FeedMatch, MatchInfo, PlayoffBracket } from "./types.js";
...
const { buildSeriesDescription } = await import("./description.js");
const { formatChapterTime } = await import("./chapters.js");
