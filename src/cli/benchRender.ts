 ...
 *
 * Defaults are what the render actually uses now (src/pipeline/overlayRender.ts): the timer strip as
...
import { webpackOverride, remotionPublicDir, remotionEntryPoint } from "../pipeline/remotionBundle.js";
