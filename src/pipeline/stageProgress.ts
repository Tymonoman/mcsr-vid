...
import type { ThumbnailProgress } from "../thumbnails/thumbnailRender.js";
...
export const STAGE_LABELS: Record<StageId, string> = {
  ...
  // Sync reads the countdown freeze in the picture (src/pipeline/countdownDetect.ts); audio is the
  // fallback.
  sync: "Sync check",
