...
export interface TitleInput {
  ...
  /** Replaces the format suffix — a playoff game's round and game number (src/playoffs/playoffs.ts). */
  suffix?: string;
}
 ...
 * checklist, the publish kit and the upload (src/youtube/youtubeStore.ts `uploadTextFor`) — and a fourth
